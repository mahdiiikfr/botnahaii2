...
class Database:
    ...
    async def _seed_static_products(self):
        # We will seed the 10 requested products with fixed IDs.
        ...
        static_products = [
            ...
            (9, 1, "اشتراک جیمینای 18 ماهه", "خرید اشتراک ۱۸ ماهه هوش مصنوعی گوگل جیمینای (Gemini) با دسترسی کامل به امکانات ویژه", 1000000, 0),
            (10, 1, "راهنمایی و رفع مشکلات مرتبط با پنل‌ها و فیلترشکن", "حل و رفع تمامی ارورها، عیب‌یابی و مشکلات مربوط به راه‌اندازی پنل‌های فیلترشکن", 250000, 0)
        ]
