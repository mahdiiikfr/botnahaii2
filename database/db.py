...
class Database:
    ...
    async def _seed_static_products(self):
        # We will seed the 7 requested products with fixed IDs.
        ...
        static_products = [
            ...
            (7, 1, "راهنمایی و رفع مشکلات مرتبط با پنل‌ها و فیلترشکن", "حل و رفع تمامی ارورها، عیب‌یابی و مشکلات مربوط به راه‌اندازی پنل‌های فیلترشکن", 250000, 0)
        ]
