...
def get_main_keyboard(user_id: int) -> InlineKeyboardMarkup:
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="📞 پشتیبانی", callback_data="support_info", style=ButtonStyle.PRIMARY)
        ]
    ]
...
def get_payment_methods_keyboard(order_id: str, product_id: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [
