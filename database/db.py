...
class Database:
    ...
    async def _seed_static_products(self):
        # We will seed the 11 requested products with fixed IDs.
        ...
        static_products = [
            ...
            (4, 1, "فیلترشکن نامحدوده تک کاربره", "فیلترشکن فوق‌العاده پرسرعت و بدون محدودیت حجم ویژه تک کاربره", 150000, 0),
            (5, 1, "ساخت و کانفیگ پنل سنایی", "نصب، راه‌اندازی و کانفیگ حرفه‌ای پنل سنایی روی سرور مجازی", 500000, 0),
            (6, 1, "سرور ایران مشخصات رم 2 سی پی یو 1 حافظه 40", "سرور ایران با مشخصات فوق‌العاده قوی و پایدار.\n\n⚠️ برای مشخصات قوی‌تر به پشتیبانی پیام بدهید یا تیکت بزنید.", 1500000, 0),
            (7, 1, "سرور ایران ۲ هسته ۴ گیگ ۴۰ گیگابایت", "سرور مجازی ایران با عملکرد و سرعت بسیار عالی.\n\n⚠️ برای مشخصات قوی‌تر به پشتیبانی پیام بدهید یا تیکت بزنید.", 2200000, 0),
            (8, 1, "سرور ایران ۴ هسته ۸ گیگ ۴۰ گیگ حافظه", "سرور مجازی ایران فوق‌العاده قدرتمند مخصوص کارهای سنگین.\n\n⚠️ برای مشخصات قوی‌تر به پشتیبانی پیام بدهید یا تیکت بزنید.", 3200000, 0),
            (9, 1, "اشتراک جیمینای 12 ماهه", "خرید اشتراک ۱۲ ماهه هوش مصنوعی گوگل جیمینای (Gemini) با دسترسی کامل به امکانات ویژه", 2000000, 0),
            (10, 1, "اشتراک جیمینای 18 ماهه", "خرید اشتراک ۱۸ ماهه هوش مصنوعی گوگل جیمینای (Gemini) با دسترسی کامل به امکانات ویژه", 2500000, 0),
            (11, 1, "راهنمایی و رفع مشکلات مرتبط با پنل‌ها و فیلترشکن", "حل و رفع تمامی ارورها، عیب‌یابی و مشکلات مربوط به راه‌اندازی پنل‌های فیلترشکن", 250000, 0)
        ]
